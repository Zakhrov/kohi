...
void vulkan_renderer_backend_create_texture_for_device(VulkanBuffer* stagingBuffers,const char* name, b8 autoRelease, i32 width, i32 height, i32 channelCount, const u8* pixels, b8 hasTransparency, struct VulkanTextureData* data, int deviceIndex);
